    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-slate-500">Start using MarketLens in seconds.</p>
        </div>
        ...
        <div className="mt-3 flex items-center justify-center text-xs text-slate-500">
          ...
          <NavLink to="/forgot-password" className="ml-1 font-semibold text-indigo-600 hover:text-indigo-700">
            Reset it
          </NavLink>
        </div>
