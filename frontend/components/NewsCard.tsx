...
import { formatSource, formatDateToUTC7 } from '../utils/formatters';
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        <span className="text-xs font-medium text-slate-500 px-2 py-1 bg-slate-50 rounded border border-slate-200">{formatSource(article.source)} • {formatDateToUTC7(article.timestamp)}</span>
        {article.sentiment && (
