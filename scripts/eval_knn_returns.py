...
async def main() -> None:
    ...
    ap.add_argument("--w1d",  type=float, default=0.15)
    ap.add_argument("--w3d",  type=float, default=0.25)
    ap.add_argument("--w7d",  type=float, default=0.35)
    ap.add_argument("--w15d", type=float, default=0.15)
    ap.add_argument("--w30d", type=float, default=0.10)
