...
7. [ETH zero-shot StockMem report](stockmem/eth_zero_shot.md)
8. [ETH fine-tune StockMem report](stockmem/eth_finetune.md)
9. [StockMem academic paper draft](stockmem/academic_paper.md)
10. [StockMem reproducibility](stockmem/reproducibility.md)
11. [AIHub LLM baseline](aihub/llm_baseline.md)
