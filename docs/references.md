...
4. Marius Koeppel, Alexander Segner, Martin Wagener, Lukas Pensel, Andreas Karwath, and Stefan Kramer. *Pairwise Learning to Rank by Neural Networks Revisited*. arXiv:1909.02768, 2019. https://arxiv.org/abs/1909.02768
...
6. FinSeer financial time-series retrieval-augmented generation reference material. arXiv:2502.05878. Local copy: `docs/upgrade/FinSeer financial time-series RAG/`.
...
Local papers and external notes are kept under `docs/upgrade/` for offline
reading. They are not required for running the code.

Key local items:

- `docs/upgrade/StockMem event-reflection memory.pdf`
- `docs/upgrade/FinBERT/`
- `docs/upgrade/PatchTST/`
- `docs/upgrade/Dissemination-aware FinGPT.pdf`
- `docs/upgrade/CryptoLin corpus.pdf`
