...
let CryptoController = class CryptoController {
    ...
    async getHistoricalData(symbol, limit, aggregate, type) {
        return this.cryptoService.getHistoricalData(symbol, limit ? parseInt(limit) : 144, aggregate ? parseInt(aggregate) : 1, type || 'minute');
    }
};
...
__decorate([
    ...
    __param(2, (0, common_1.Query)('aggregate')),
    __param(3, (0, common_1.Query)('type')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String]),
    __metadata("design:returntype", Promise)
], CryptoController.prototype, "getHistoricalData", null);
